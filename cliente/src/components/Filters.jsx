  ...
  return (
    <div>
      <div className={styles.containerSearch}>
        <input className={styles.inputSearch} htmlFor="search" onChange={(event) => setText(event.target.value)} />
        <img className={styles.searchImage} src={search} alt="Search" />
        <label className={styles.labelSearch} htmlFor="search">Pesquisar</label>
      </div>
